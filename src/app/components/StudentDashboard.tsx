                  ...
                  <div className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-3">
                    ...
                    <div className="space-y-2 text-xs">
                      ...
                      <div>
                        ...
                        <span className="font-bold text-slate-800 dark:text-slate-200">{user.educationLevel || 'Senior High School (SHS)'}</span>
                      </div>
                      <div>
                        <span className="text-muted-foreground block">School / Class Code:</span>
                        <span className="font-bold text-slate-800 dark:text-slate-200">{user.className || 'Not Linked'} ({user.organizationName || user.school || 'Self-Registered'})</span>
                      </div>
                    </div>
                  </div>
