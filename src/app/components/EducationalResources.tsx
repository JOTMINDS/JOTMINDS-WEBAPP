      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-3">
          {loading ? (
            <div className="flex items-center justify-center p-8">
              ...
              <span className="text-sm text-muted-foreground">Generating personalized resources...</span>
            </div>
          ) : resources.length === 0 ? (
        ...
        <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
          <p className="text-sm text-blue-900 dark:text-blue-100">
            <strong>Note:</strong> These resources are tailored specifically based on your cognitive profile metrics. 
            {userType === 'parent' 
